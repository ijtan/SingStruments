...
IconSelect.COMPONENT_ICON_FILE_PATH = "static/Images/arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.showBox = function($isShown){
        ...
        if($isShown) {
            ...
            document.getElementById("dropdown").setAttribute("style","transform: rotate(-90deg);");
        }else{
            _View.boxElement.style.display = "none";
            _View.boxScrollElement.style.display = "none";
            document.getElementById("dropdown").setAttribute("style","transform: none;");
        }
    ...
    _View.createUI = function($parameters){
        ...
        componentIconImgElement.setAttribute('width', '30');
        componentIconImgElement.setAttribute('height', '30');
        componentIconImgElement.id = "dropdown";
